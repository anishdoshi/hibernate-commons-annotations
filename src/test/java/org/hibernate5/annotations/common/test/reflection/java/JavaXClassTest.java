...
import org.hibernate5.annotations.common.test.reflection.java.generics.Dad;
import org.hibernate5.annotations.common.test.reflection.java.generics.Grandpa;
import org.hibernate5.annotations.common.test.reflection.java.generics.Language;
import org.hibernate5.annotations.common.test.reflection.java.generics.Son;
...
public class JavaXClassTest extends XAnnotatedElementTestCase {
	...
	public void testHasAName() {
		assertSame( "org.hibernate5.annotations.common.test.reflection.java.generics.Dad", fatherAsSeenFromSon.getName() );
	}
