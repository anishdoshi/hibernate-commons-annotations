package org.hibernate5.annotations.common.test.annotationfactory;

import java.lang.reflect.Method;

import org.hibernate5.annotations.common.annotationfactory.AnnotationDescriptor;
import org.hibernate5.annotations.common.annotationfactory.AnnotationProxy;
...
public class AnnotationProxyTest extends TestCase {
	...
	public void testItsToStringConformsToTheJavaAnnotationDocumentation() throws Throwable {
		String expectedString = "@org.hibernate5.annotations.common.test.annotationfactory.TestAnnotation(booleanElement=false, elementWithDefault=abc, someOtherElement=y, stringElement=x)";
